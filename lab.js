...
let gandalf = new Wizard('Gandalf', 100, 'Fireball')
...
let iPhone = new Phone ('iPhone', 'X', 24, 'black', 999.99)
let android = new Phone ('Galaxy', 'S9', 36, 'black', 899.99)
let blackberry = new Phone ('Black', 'Berry', 12, 'white', 199.99)
...
//Code Here
var myFirstVehicle = new Vehicle(4,'red',1500)
...
//Code Here 
var myFirstMotorcycle = new Motorcycle(2, 'black', 400, 'Harley', true)
...
//Code Here
var myFirstBoat = new Boat(12, 'yellow', 6000, 'The Yellow Pearl', 'pirate ship', false);
